app.controller('administratorCtrl', ['$scope', '$http','$rootScope', function($scope, $http, $rootScope){
	...
	// add subjects
	$scope.addSubjects = function(id,courseName, courseDes, subject){
		var course_level = $scope.subjectsOfYear;
		var	course_term = $scope.subjectsOfTerm;

		var content={
			year_level: course_level, 
			term: course_term, 
			course_name: courseName,
			course_des: courseDes,
			subject_name: subject.subName, 
			subject_des:subject.subDes,
			units:subject.subUnits,
			cost_perUnits:subject.subCpu,
			pre_requisite:subject.subPreRequisite
		};
